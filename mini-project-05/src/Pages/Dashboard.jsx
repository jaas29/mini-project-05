...
const Dashboard = ({wishlist = [], watched = [], removeMovie, removeWatched, loading, error, toggleWishlist, toggleWatched, filteredMovies = [], paginatedMovies = [], totalPages = 5, genres = [], ageGroups = [], years = [], searchQuery = "", selectedGenre = "", selectedAgeGroup = "", selectedYear = "", sortOrder = "", currentPage = 1, setCurrentPage, handleSearchChange, handleGenreChange, handleAgeGroupChange, handleYearChange, handleSortChange}) => {
    return (
        <>
            ...
            <div className='background flex flex-col items-center text-center px-6 py-10 bg-[#031926]'>
                <div className='justify-center align-middle'>
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#77ACA2] m-10">Welcome <span className="text-[#F4E9CD]"> </span></h1>
