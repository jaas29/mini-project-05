...
const SignUp = () => {
    ...
    // useNavigate lets us redirect the user after signup
    const navigate = useNavigate();
    // Local state to show errors to the user
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            // Set the user's display name so we can greet them later
    ...
    const handleGoogleSignIn = async () => {
        try {
            await googleSignIn(); // opens the Google popup
            navigate("/dashboard");
        } catch (err) {
            setError(err.message);
        }
            ...
            <StyledWrapper>
                <div className="background">
                    ...
                    <div className='div flex mt-40 justify-center mb-20'>
                        <form className="form flex justify-center w-90" onSubmit={handleSignUp}>
